...
/**
 * Generated class for the ItemDetail_04Page page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 * 江苏快3 广西快3 吉林快3 河北快3 内蒙古快3 安徽快3 福建快3
 * 湖北快3 北京快3 公用此页
 */
declare var $:any;
@IonicPage()
@Component({
  selector: 'page-item-detail-04',
  templateUrl: 'item-detail-04.html',
})
export class ItemDetail_04Page {
