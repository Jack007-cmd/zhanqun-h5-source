...
/**
 * Generated class for the ItemDetail_02Page page.
 *
...
@IonicPage()
@Component({
  selector: 'page-item-detail-02',
  templateUrl: 'item-detail-02.html',
})
export class ItemDetail_02Page {
