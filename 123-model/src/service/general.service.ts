...
export class GeneralService {
  ...
  // public preUrl=this.appConfig.imgHost+'/lottery/lotteryVideo/index.html?key=';
  ...
  //   return this.appHttp.post("/index/read-information", {id: id});
  //
  // }
  ...
  //首页轮播图
  getBanner() {
  //   // return this.appHttp.post("/index/banner", {type: 1});
