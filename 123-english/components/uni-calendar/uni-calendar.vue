		...
		<view v-if="insert || show" class="uni-calendar__content" :class="{'uni-calendar--fixed':!insert,'uni-calendar--ani-show':aniMaskShow}">
			<view v-if="!insert" class="uni-calendar__header uni-calendar--fixed-top">
				<view class="uni-calendar__header-btn-box" @click="close">
					<text class="uni-calendar__header-text uni-calendar--fixed-width" style="margin-left: 25rpx;">cancel</text>
				</view>
				<view class="uni-calendar__header-btn-box" @click="confirm">
					<text class="uni-calendar__header-text uni-calendar--fixed-width" style="margin-right: 35rpx;">confirm</text>
				</view>
			</view>
			<view class="uni-calendar__header">
				...
				<!--<picker mode="date" :value="date" fields="month" @change="bindDateChange">
					...
					<text class="uni-calendar__header-text header-text-time">{{ month[nowDate.month] +' '+ nowDate.year}}</text>
				</picker>-->
				<view>
					<text class="uni-calendar__header-text header-text-time">{{ month[nowDate.month] +' '+ nowDate.year}}</text>
				</view>
				...
				<text class="uni-calendar__backtoday" @click="backtoday">back to today</text>
