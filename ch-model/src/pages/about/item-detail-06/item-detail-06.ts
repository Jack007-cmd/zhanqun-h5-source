...
/**
 * Generated class for the ItemDetail_06Page page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 * 双色球 超级大乐透 体彩七星彩 共用此页
 */
declare var $:any;
@IonicPage()
@Component({
  selector: 'page-item-detail-06',
  templateUrl: 'item-detail-06.html',
})
export class ItemDetail_06Page {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private alertService: AlertService,
              private aboutService: AboutService, private storageService: StorageService
