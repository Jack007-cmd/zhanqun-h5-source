...
/**
 * Generated class for the ItemDetail_10Page page.
 *
...
@IonicPage()
@Component({
  selector: 'page-item-detail-10',
  templateUrl: 'item-detail-10.html',
})
export class ItemDetail_10Page {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private alertService: AlertService,
              private aboutService: AboutService, private storageService: StorageService,private browser:Browser) {
