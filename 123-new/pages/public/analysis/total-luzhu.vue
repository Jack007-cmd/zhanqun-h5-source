	...
	<view class="container" v-if="mainData">
		...
		<view class="content-list">
			<view class="content-title">
				...
				<view class="title-right">总和&nbsp;&nbsp;大小&nbsp;&nbsp;最新&nbsp;&nbsp;↓</view>
			</view>
			<view class="table-box">
				<table @touchstart.stop @touchend.stop border="0" cellpadding="1" cellspacing="1">
					<tbody>
...
export default {
	...
	methods: {
		getAnalysisDetail() {
			let that = this;
			this.$api.getAnalysisDetail({ code: this.code, type: 'zhlz', date: this.date }).then(res => {
				uni.hideLoading();
				if (res.code == 0) {
