		...
		<view v-if="!showList">
			<view class="detail-container">
				...
				<view class="boxline"  v-if="aboutList">
					<view class="box" >
						<view class="k3" v-for="(ccode, index) in aboutList['current_code']" :key="code+'-'+index" :class="{ num1: ccode == '1', num2: ccode == '2', num3: ccode == '3', num4: ccode == '4', num5: ccode == '5', num6: ccode == '6' }"></view>
					</view>
				</view>
				<view class="boxline">
			...
			<view class="anasysis">
				...
				<view v-if="sortList.length>1" class="font_icon iconsytriangle" @click="showAll=true"></view>
			</view>
			<view>
				...
				<position-trend v-if="currentSort == 'dwzs'" :code="code" :date="date" :current_number="current_number" :series="0"></position-trend>
