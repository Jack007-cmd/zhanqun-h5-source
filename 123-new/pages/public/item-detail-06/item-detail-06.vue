			...
			<view class="detail-container">
				<view class="boxline">
					<view class="box-title">
						...
						<!-- <view class="open-video">视频</view> -->
					</view>
				</view>
				<view class="boxline"  v-if="aboutList">
					<view class="box" >
						<view class="ssc" v-for="(ccode, index) in aboutList['current_code']" :key="code+'-'+index" :class="{ lastBall:  (code=='cjdlt' && index >= 5) || (code!='cjdlt' && index == 6)}">{{ ccode }}</view>
					</view>
				</view>
				<view class="boxline">
