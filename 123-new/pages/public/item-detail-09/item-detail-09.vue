		...
		<view v-if="!showList">
			<view class="detail-container">
				...
				<view class="boxline"  v-if="aboutList">
					<view class="box" >
						<view class="ssc ssc_num5" v-if="code=='tcplw'" v-for="(ccode, index) in aboutList['current_code']" :key="code+'-'+index">{{ ccode }}</view>
						<view class="ssc" v-else v-for="(ccode, index) in aboutList['current_code']" :key="code+'-'+index">{{ ccode }}</view>
					</view>
				</view>		
				<view class="boxline">
